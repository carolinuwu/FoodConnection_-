...
namespace FoodConnection__.Controllers
{
    ...
    public class RestaurantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Direccion,PathImagen")] Restaurante restaurante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Direccion,PathImagen")] Restaurante restaurante)
        {
